...
export default function AdminLoginPage({ onLogin }: AdminLoginPageProps) {
  ...
  return (
    <div className="mx-auto max-w-xl rounded-4xl border border-slate-200 bg-white p-10 shadow-soft">
      ...
      <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
        ...
        <button
          type="submit"
          className="w-full rounded-3xl bg-slate-900 px-6 py-3 text-sm font-semibold text-white transition hover:bg-slate-800"
        >
          Sign in
        </button>
